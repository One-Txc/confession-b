...
CREATE TABLE `main_config` (
  ...
  `titile` varchar(256) DEFAULT NULL COMMENT 'title',
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COMMENT='配置表';
...
CREATE TABLE `popup_config` (
  ...
  `order` int(2) unsigned NOT NULL COMMENT '排序,越小越考前',
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 COMMENT='弹窗配置表';
