CREATE TABLE `main_config` (
  ...
  `state` varchar(2) DEFAULT NULL COMMENT '状态[0-不可用,1-可用]',
...
CREATE TABLE `certificate` (
  `certificate_code` varchar(64) NOT NULL COMMENT '凭证code',
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`popup_config_id`)
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8mb4 COMMENT='添加配置凭证';
